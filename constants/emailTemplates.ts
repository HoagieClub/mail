...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  ...
  },
  {
    ...
    <p><strong>🕙 Time:</strong> [Start–End Time]</p>
  ...
  },
  {
    ...
    <br>
    <p><strong>Application Deadline:</strong> [Day], [Date] at [Time]</p>
    <p><strong>Apply here:</strong> [Link / Instructions]</p>
    <br>
    <p><strong>About [Organization / Program]:</strong></p>
    <p>[Provide 2–4 sentences describing the organization or program. Include mission, impact, notable projects, and why it’s meaningful.]</p>
    ...
    <br>
    <p>We can’t wait to see your application and learn more about what you can bring to <strong>[Organization / Program Name]</strong>!
    <p>— [Organization Name]</p>`,
  },
  {
    type: 'survey',
