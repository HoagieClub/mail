    ...
    if (userScheduledMail?.status === 'unused') {
        return (
            <Pane>
                ...
                <Alert intent='none'>
                    Emails relating to University Clubs, Departments, and
                    Organizations can be scheduled up to four days in advance.
                    Other emails will be bundled into a Digest email. You can
                    modify your scheduled emails here.
                </Alert>
                <br />
                <Link href='/app'>
    ...
    return (
        <Pane>
            ...
            <Alert intent='none'>
                ...
                the content of your email or send it now, simply delete it and
                make a new request. Deleted emails will not be sent.
            </Alert>
            <ScheduledMailPane
